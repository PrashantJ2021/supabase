...
Your project's Postgres version needs to be 15.1.173+ to use this extension. You can check and upgrade your project in the [Settings](https://supabase.com/dashboard/project/tvpxklkoidtevipfmlyv/settings/infrastructure)
</Admonition>
